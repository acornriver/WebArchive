document.addEventListener('DOMContentLoaded', () => {
    const projects = [
        { id: 'p0', title: '00 파인딩 마이 패스', year: '2021', category: 'Sound / Movie', thumbnail: 'asset/WebIndependence/00파인딩 마이 패스/파인딩 마이 패스_썸네일 2021, acornriver.jpg', images: ['asset/WebIndependence/00파인딩 마이 패스/파마패1.png','asset/WebIndependence/00파인딩 마이 패스/파마패2.png','asset/WebIndependence/00파인딩 마이 패스/파마패3.png','asset/WebIndependence/00파인딩 마이 패스/파마패4.png'], rtf: 'asset/WebIndependence/00파인딩 마이 패스/파인딩 마이 패스 txt.rtf' },
        { id: 'p1', title: '01 자아분열', year: '2023', category: 'Short Film, Media Art', thumbnail: 'asset/WebIndependence/01자아분열/자아분열_썸네일 2023, acornriver.png', images: ['asset/WebIndependence/01자아분열/자아분열1.png','asset/WebIndependence/01자아분열/자아분열2.png','asset/WebIndependence/01자아분열/자아분열3.png'], rtf: 'asset/WebIndependence/01자아분열/자아분열 txt.rtf' },
        ...
        { id: 'p7', title: '07 모서리인간', year: '2024', category: 'Short Film', thumbnail: 'asset/WebIndependence/07모서리인간/모서리인간_썸네일 2024, acornriver.png', images: ['asset/WebIndependence/07모서리인간/모서리인간1.png','asset/WebIndependence/07모서리인간/모서리인간2.png'], rtf: 'asset/WebIndependence/07모서리인간/모서리인간 txt.rtf' },
        ...
        { id: 'p14', title: '14 빛의 언어', year: '2025', category: 'Research / test', thumbnail: 'asset/WebIndependence/14 빛의 언어/빛의언어_썸네일 2025, acornriver.png', images: ['asset/WebIndependence/14 빛의 언어/빛의언어1.png','asset/WebIndependence/14 빛의 언어/빛의언어2.png'], rtf: 'asset/WebIndependence/14 빛의 언어/빛의언어 txt.rtf' },
