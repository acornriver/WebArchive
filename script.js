document.addEventListener('DOMContentLoaded', () => {
    const projects = [
        ...
        { id: 'p1', title: '01 자아분열', year: '2023', category: 'Short Film', thumbnail: 'asset/WebIndependence/01자아분열/자아분열_썸네일 2023, acornriver.png', images: ['asset/WebIndependence/01자아분열/자아분열1.png','asset/WebIndependence/01자아분열/자아분열2.png','asset/WebIndependence/01자아분열/자아분열3.png','asset/WebIndependence/01자아분열/파마패1.png'], rtf: 'asset/WebIndependence/01자아분열/자아분열 txt.rtf' },
        ...
        { id: 'p8', title: '08 철의 언어', year: '2025', category: 'Installation', thumbnail: 'asset/WebIndependence/08디지털기반의인스톨레이션-철의언어/디지털 기반의 인스톨레이션 철의 언어 _썸네일 2024,  acornriver.png', images: ['asset/WebIndependence/08디지털기반의인스톨레이션-철의언어/철의언어1.png','asset/WebIndependence/08디지털기반의인스톨레이션-철의언어/철의언어2.png','asset/WebIndependence/08디지털기반의인스톨레이션-철의언어/철의언어3.png','asset/WebIndependence/08디지털기반의인스톨레이션-철의언어/철의언어4.png','asset/WebIndependence/08디지털기반의인스톨레이션-철의언어/철의언어5.png'], rtf: 'asset/WebIndependence/08디지털기반의인스톨레이션-철의언어/미리별 txt.rtf' },
        ...
        { id: 'p10', title: '10 연산적시', year: '2024', category: 'AV / Experimental', thumbnail: 'asset/WebIndependence/10연산적시/연산적 시_썸네일 2025, acornriver.png', images: ['asset/WebIndependence/10연산적시/연산적시1.png','asset/WebIndependence/10연산적시/연산적시2.png','asset/WebIndependence/10연산적시/연산적시3.png','asset/WebIndependence/10연산적시/연산적시4.png','asset/WebIndependence/10연산적시/연산적시5.png'], rtf: 'asset/WebIndependence/10연산적시/연산적시 txt.rtf' },
        { id: 'p11', title: '11 오브메모리오브', year: '2024', category: 'Exhibition', thumbnail: 'asset/WebIndependence/11오브메모리오브/오브메모리오브_썸네일 2025, acornriver.png', images: ['asset/WebIndependence/11오브메모리오브/오메오1.png','asset/WebIndependence/11오브메모리오브/오메오2.png','asset/WebIndependence/11오브메모리오브/오메오3.png','asset/WebIndependence/11오브메모리오브/오메오4.png'], rtf: 'asset/WebIndependence/11오브메모리오브/오브메모리오브 txt.rtf' },
